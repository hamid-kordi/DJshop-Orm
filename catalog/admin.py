...
from catalog.models import Category, ProductClass, Option, ProductAttribute, ProductRecommendation, Product, \
...
class ProductClassAdmin(admin.ModelAdmin):
    list_display = ('title', 'slug', 'require_shop', 'track_stock', 'attribute_count')
    list_filter = ('require_shop', 'track_stock', AttributeCountFilter)
