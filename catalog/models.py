...
class ProductAttribute(models.Model):
    class AtribiuteTypeChoise(models.TextChoices):
        text = 'text'
        integer = 'integer'
        float = 'float'
        option = 'option'
        multi_option = 'multi_option'
    product_class = models.ForeignKey(ProductClass,on_delete=models.CASCADE,null= True,related_name='attribute')
    title = models.CharField(max_length=256)
    type = models.CharField(max_length=256,choices=AtribiuteTypeChoise.choices, default=AtribiuteTypeChoise.text)
